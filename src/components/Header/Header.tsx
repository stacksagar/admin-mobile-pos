    ...
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-1 sm:gap-4 lg:hidden">
          ...
          <Link className="block flex-shrink-0 font-extrabold lg:hidden" to="/">
            <div className="-rotate-12 transform pl-2 text-lg text-blue-300 md:text-3xl">
            ...
            >
              <IconButton color="primary">
                <div className="text-blue-600">
                  <FIcon icon="internet-explorer" size="sm" />
                </div>
              </IconButton>
            </motion.a>
            {/* <!-- Notification Menu Area --> */}
