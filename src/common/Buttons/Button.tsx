  ...
  useEffect(() => {
    setDynamicClass(
      classNames({
        ...
        "hover:bg-black bg-official-button text-white":
          color === "official-button-red",
        "": color === "custom",
        // "hover:bg-black hover:text-white": color === "official-button-black",
        // "hover:bg-black hover:text-white": color === "official-button-logo1",
        // "hover:bg-black hover:text-white": color === "official-button-logo2",
        ring: selected,
      })
    );
  }, [size]);
