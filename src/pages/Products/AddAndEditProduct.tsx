...
export default function AddAndEditProduct() {
  ...
  useEffect(() => {
    ...
    productVariants?.forEach((v) => {
      total_purchase_amount += Number(v?.purchase_price) || 0;
      total_sale_amount += Number(v?.sale_price) || 0;
      v?.imei && (in_stock += 1);
    });
  ...
  return (
    <div>
      ...
      >
        <div className="space-y-8 bg-white p-8 dark:bg-black xl:col-span-8">
          <div className="grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-2">
            ...
            <div className="flex cursor-pointer items-center gap-1 text-lg font-semibold">
              ...
              <Checkbox
                onChange={(e) => with_variant.set(e.target.checked)}
                id="with_variants"
              />
            </div>
        ...
        <div className="h-fit space-y-8 bg-white p-8 dark:bg-black xl:col-span-4">
